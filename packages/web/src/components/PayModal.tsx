  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="border-4 border-on-surface bg-white comic-shadow-lg p-6 max-w-sm w-full space-y-4">
        ...
        <p className="text-sm text-secondary text-center">Your free tier is used. Pay to continue creating manga.</p>
        ...
        <div className="border-2 border-on-surface bg-surface-container p-3 text-center">
          ...
          <p className="font-label text-[10px] text-secondary mt-1">Your balance: ${balanceFormatted} USDC</p>
        </div>
        ...
        <button onClick={onClose} className="w-full text-center font-label text-xs text-secondary uppercase">Cancel</button>
      </div>
    </div>
  );
}
