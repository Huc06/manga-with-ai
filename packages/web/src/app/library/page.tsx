...
export default function LibraryPage() {
  ...
  return (
    <main className="pt-6 px-4 max-w-7xl mx-auto relative">
      ...
      <Link
        href="/create"
        className="block relative w-full group overflow-hidden border-4 border-on-surface comic-shadow-lg active:translate-x-1 active:translate-y-1 active:shadow-none transition-all mb-6"
      >
        <div className="relative py-12 flex flex-col items-center justify-center bg-white speed-lines">
          <span className="font-display text-5xl md:text-6xl text-on-surface mb-3 tracking-tighter uppercase italic">
            NEW SERIES
          </span>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <span className="font-label text-xs bg-on-surface text-white px-2.5 py-1 font-bold">
        ...
        {!isAuthed && (
          <div className="col-span-2 border-4 border-on-surface bg-white shadow-[6px_6px_0px_0px_#1a1c1c] p-6 text-center">
            ...
            <p className="text-sm text-secondary mb-4">
              Connect wallet to see and manage your manga.
            </p>
            <button
